...
eval("$.get('./data.json', function (data) {\n  myChart(data);\n});\n\nfunction myChart(data) {\n  var ctx = $(\"#myChart\")[0].getContext('2d');\n  var myChart = new Chart(ctx, {\n    type: 'line',\n    data: {\n      labels: data.chartLabels,\n      datasets: [{\n        label: 'Balance',\n        data: data.chartData,\n        backgroundColor: 'rgb(84,28,169)',\n        borderColor: '#CDA8EE',\n        borderWidth: 1,\n        fill: true,\n        tension: 0.4\n      }]\n    },\n    options: {\n      scales: {\n        y: {\n          display: false,\n          beginAtZero: true\n        }\n      },\n      plugins: {\n        legend: {\n          display: false\n        }\n      }\n    }\n  });\n}\n\n//# sourceURL=webpack://material-design-project/./app.js?");
...
/******/ 	__webpack_modules__["./app.scss"](0, {}, __webpack_require__);
